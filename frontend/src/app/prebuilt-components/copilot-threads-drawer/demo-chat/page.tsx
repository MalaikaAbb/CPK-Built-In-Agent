 ...
 * root. The doc nests them because its sample is a whole page, and its provider
 * carries `publicLicenseKey` — this harness passes that on the root provider
 * instead, from `NEXT_PUBLIC_COPILOTKIT_LICENSE_KEY`.
 *
